export  function jugadaInvalida(celda, valor, estado) {
  let filaError = 10;
  let columError = 10;
  let cuadroError = 10;
  let celdaError = false;
  ...
  for (let i = 0; i < colum.length; i++) {
    ...
    if (f != (-1)) {
      ...
      for (let e = 0; e < colum[i].length; e++) {
        if (estado[colum[i][e]] == valor) {
          celdaError = colum[i][e]
        }
      }
      break
    }
  ...
  for (let i = 0; i < cuadro.length; i++) {
    ...
    if (f != (-1)) {
      ...
      for (let e = 0; e < cuadro[i].length; e++) {
        if (estado[cuadro[i][e]] == valor) {
          celdaError = cuadro[i][e]
        }
      }
      break
    }
